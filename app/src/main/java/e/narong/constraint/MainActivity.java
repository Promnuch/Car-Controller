...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageButton bluetooth2;

    private final String DEVICE_ADDRESS = "00:18:E5:04:73:88"; //MAC Address of Bluetooth Module
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bluetooth2= (ImageButton)findViewById(R.id.connect2);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowTitleEnabled(false);
        actionBar.setDisplayShowCustomEnabled(true);

        View CustomActionbarView = LayoutInflater.from(this)
